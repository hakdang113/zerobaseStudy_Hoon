...
<%-- 북마크 보기 페이지에서 특정 번호(listID)를 매개변수로 하여 데이터를 삭제하는 페이지 --%>
<body>

	<%
	int listID = Integer.parseInt(request.getParameter("listID"));	
	 
	BookMarkListOption bookmarkOption = new BookMarkListOption();
	
	int result = bookmarkOption.delBookmarkList(listID);
